...
import type { PDFOptions } from 'html-export-pdf-cli'
...
export async function generatePdf({
  ...
  const res = await mergePDF(normalizePages, outFile, outDir, pdfOutlines)
  const message = `\nExported to ${pc.yellow(res.mergedPdfPath)}\n`
